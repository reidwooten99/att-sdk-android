...
public class AdsViewActivity extends Activity implements ATTAdViewListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button btnGetAd = (Button) findViewById(R.id.btnGetAd);
	 ...
	 * Returns category.
	 *
	 * @return dialog UI to select a category
	 */
	...
	private void setAdLayoutParams() {
		...
		attAdView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height+(height/2)));
